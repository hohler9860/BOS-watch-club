    ...
    <div className={s.loginPage}>
      <form className={s.loginCard} onSubmit={handleSubmit}>
        ...
        <button
          ...
          style={{ background: '#fff', color: '#333', border: '1px solid #ddd', marginBottom: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
        >
        ...
        <div style={{ textAlign: 'center', color: '#999', fontSize: 12, margin: '8px 0 16px', fontFamily: 'var(--font-sans)' }}>or sign in with email</div>
