...
// h1 32px / body 16px; clear (outline) black buttons matching the site.
...
export function signupEmail({ firstName = 'Member' }) {
  return layout({
    ...
    content: `
      ...
      <p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0 0 16px 0;">
        Your BOS Watch Club account has been created. You're one step closer to joining Boston's premier watch community.
      </p>
      <p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0 0 24px 0;">
...
export function newEventEmail({ firstName = 'Member', eventName = '', venue = '', date = '', time = '', dressCode = '', access = '', description = '', image = '' }) {
  ...
  const descBlock = description
    ? `<p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0 0 24px 0;">${description}</p>`
    : ''
  return layout({
...
export function eventReminderEmail({ firstName = 'Member', eventName = '', venue = '', date = '', time = '', dressCode = '' }) {
  return layout({
    ...
    content: `
      ...
      <p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0;">
...
export function newContentEmail({ firstName = 'Member', contentType = 'news', title = '', preview = '' }) {
  ...
  return layout({
    ...
    content: `
      ...
      ${preview ? `<p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0 0 24px 0;">${preview}</p>` : ''}
      ${button(ctaText, link)}
    `,
  })
}
...
export function customBlastEmail({ preview = '', heading = '', body = '', buttonText = '', buttonHref = '', image = '' }) {
  const imageBlock = image
    ...
    : ''
  const bodyHtml = body
    ? `<p style="font-family:${fonts.body};color:${colors.muted};font-size:16px;font-weight:400;line-height:1.7;text-align:center;margin:0 0 24px 0;">${body.replace(/\n/g, '<br>')}</p>`
    : ''
